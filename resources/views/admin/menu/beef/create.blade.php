    ...
    @component('layouts.widgets.submitForm', ['id'=>'createForm','method'=> isset($edit) ? 'PUT' : 'POST' ,'action'=> isset($edit)&&isset($data->id) ? asset($route.'/'.$data->id) : asset($route),'backUrl'=>asset($route),'errors'=> isset($errors) ? $errors : '' ] )
        @slot('panelTitle', 'Regular Table')
            ...
            <div class="form-group">
                <label for="ex">ชื่อ รูป (ไทย)</label>
                <input id="name_th" name="name_th" placeholder="ชื่อ รูป (ไทย)" class="form-control require-field" value="{{ isset($data->name_th) ? $data->name_th : '' }}">
            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_1_5.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_1_5.jpg') }}" target="_blank" >
            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_1_'.($i+1).'.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_1_'.($i+1).'.jpg') }}" target="_blank" >
                        <i class="fa fa-info-circle"></i>
                    </a>
                  </div>
                </div>
