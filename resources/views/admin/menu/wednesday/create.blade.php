            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_11_9.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_11_9.jpg') }}" target="_blank" >
            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_11_'.($i+1).'.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_11_'.($i+1).'.jpg') }}" target="_blank" >
                        <i class="fa fa-info-circle"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <div class="span-field fl">(ขนาดที่เหมาะสม {{ $resize[0]['w'].' x '.$resize[0]['h'] }} px)</div>
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_11_6.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_11_6.jpg') }}" target="_blank" >
                        <i class="fa fa-info-circle"></i>
                    </a>
                  </div>
                </div>
