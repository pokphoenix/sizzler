		...
		<div class="row">
			...
			<div class="col-sm-6">
	           ...
	           <a href="{{ asset($route.'/'.$categoryId.'/edit') }}" class="btn btn-warning" type="button" title="แก้ไขรายการ">
	            ...
	            <a data-toggle="tooltip" data-placement="bottom" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_11.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_11.jpg') }}" target="_blank" >
