            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_6_6.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_6_6.jpg') }}" target="_blank" >
            ...
            <div class="form-group">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <br>
                     <a data-toggle="tooltip" data-placement="right" class="btn btn-info" title="<img src='{{ asset('/img/backend/m_6_'.($i+1).'.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/m_6_'.($i+1).'.jpg') }}" target="_blank" >
                        <i class="fa fa-info-circle"></i>
                    </a>
                  </div>
                </div>
