		...
		<div class="row">
			...
			<div class="col-sm-6">
	            ...
	            <a href="{{ asset($route.'/position') }}" class="btn btn-primary" type="button" title="จัดเรียงการแสดงผล">
	             ...
	             <a data-toggle="tooltip" data-placement="bottom" class="btn btn-info" title="<img src='{{ asset('/img/backend/p_2_1.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/p_2_1.jpg') }}" target="_blank" >
				    ...
				    <tbody>
				        ...
				        <tr >
				            ...
				            <td class="v-mid">
								...
								<div class="col-sm-2">
									<a href="{{ asset('/th/pro-slider-preview/'.$t->id) }}" target="_blank" class="btn btn-default btn-circle"><i class="fa fa-file-text-o" title="read item"></i></a> 
								</div>
								<div class="col-sm-2">
									@if ($auth)
