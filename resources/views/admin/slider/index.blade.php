	...
	<div class="col-sm-12">
		<div class="row">
			...
			<div class="col-sm-6">
	            ...
	            <a data-toggle="tooltip" data-placement="bottom" class="btn btn-info" title="<img src='{{ asset('/img/backend/home001.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/home001.jpg') }}" target="_blank" >
				    ...
				    <tbody>
				        ...
				        <tr >
				            ...
				            <td class="v-mid">
								...
								<div class="col-sm-2">
									<a href="{{ asset('/th/home-slider-preview/'.$t->id) }}" target="_blank" class="btn btn-default btn-circle"><i class="fa fa-file-text-o" title="read item"></i></a> 
								</div>
								<div class="col-sm-2">
									@if ($auth)
