	...
	<div class="col-sm-12">
		<div class="row">
			...
			<div class="col-sm-6">
	            ...
	            <a data-toggle="tooltip" data-placement="bottom" class="btn btn-info" title="<img src='{{ asset('/img/backend/home005.jpg') }}'  />"  data-fancybox="gallery" href="{{ asset('/img/backend/home005.jpg') }}" target="_blank" >
