...
<div class="btn-group" role="group" aria-label="...">
	...
	<button type="button" id="statusOn" class="btn btn-{{ (isset($editStatus)&&!empty($editStatus)) ? 'primary' : 'default'  }} btn-on-off btn-circle" value="{{ (isset($editStatus)&&!empty($editStatus)) ? $editStatus : 1  }}">Yes</button>
</div>
</div>
