 	...
 	<main class="phoinikas--body-main phoinikas--page-menu">
		<div class="phoinikas--wrapper phoinikas--wrapper-global">
			<section class="phoinikas--menu-maincourse -beef">
				...
				<img src="{{  isset($beefCate->thumbnail_th) ? asset('storage/upload/'.$beefCate->thumbnail_th) : asset('/img/resource/thumbnail-default.jpg') }}" alt="{{ $beefCate->name_th }}">
				...
				<img src="{{  isset($beefCate->thumbnail_en) ? asset('storage/upload/'.$beefCate->thumbnail_en) : asset('/img/resource/thumbnail-default.jpg') }}" alt="{{ $beefCate->name_en }}">
