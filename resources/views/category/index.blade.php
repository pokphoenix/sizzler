...
<style>
	...
	a.no-line { text-decoration: none; color:#636B6F;  }
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group input-group">
                    <input type="text" class="form-control" id="search" name="search" data-href="{{ asset('') }}" value="{{ $search }}">
			...
			<div class="col-sm-6">
				<a href="{{ asset('/category/create') }}" class="btn btn-success" type="button" title="เพิ่มข้อมูล">
	                <i class="fa fa-plus"></i>
	            </a>
	            <a href="{{ asset('/category/position') }}" class="btn btn-primary" type="button" title="จัดเรียงการแสดงผล">
				    ...
				    <tbody>
				        ...
				        <tr >
				            ...
				            <td style="vertical-align:middle;">
								...
								<div class="col-sm-2">
									<a href="{{ asset('/category/'.$t->id.'/edit') }}" class="btn btn-warning btn-circle" title="edit item"><i class="fa fa-edit"></i></a>
								</div>
								<div class="col-sm-2">
									<a href="{{ asset('/category/'.$t->id) }}" class="btn btn-default btn-circle"><i class="fa fa-file-text-o" title="read item"></i></a> 
								</div>
								<div class="col-sm-2">
									<form class="form-group" method="post" action="{{ asset('/category/'.$t->id) }}">
											 {{ csrf_field() }}
											{{ method_field('DELETE') }}
...
$(function() {
	$("#search").on('keyup',function(e){
		var url = $(this).data("href")+"category?search="+$(this).val() ;
