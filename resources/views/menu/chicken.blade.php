 	...
 	<main class="phoinikas--body-main phoinikas--page-menu">
		<div class="phoinikas--wrapper phoinikas--wrapper-global">
			...
			@if (App::getLocale()=='th') 
				...
				<img src="{{ asset('storage/upload/'.$chickenCate->thumbnail_th) }}" alt="{{ $chickenCate->name_th }}">
			...
			@else
				...
				<img src="{{ asset('storage/upload/'.$chickenCate->thumbnail_en) }}" alt="{{ $chickenCate->name_en }}">
