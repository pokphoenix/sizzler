 	...
 	<main class="phoinikas--body-main phoinikas--page-menu">
		<div class="phoinikas--wrapper phoinikas--wrapper-global">
			...
			@if (App::getLocale()=='th') 
				...
				<img src="{{  isset($chickenCate->thumbnail_th) ? asset('storage/upload/'.$chickenCate->thumbnail_th) : asset('/img/resource/thumbnail-default.jpg') }}" alt="{{ $chickenCate->name_th }}">
			...
			@else
				...
				<img src="{{  isset($chickenCate->thumbnail_en) ? asset('storage/upload/'.$chickenCate->thumbnail_en) : asset('/img/resource/thumbnail-default.jpg') }}" alt="{{ $chickenCate->name_en }}">
