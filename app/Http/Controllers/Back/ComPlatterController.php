...
use stdClass ;
use Auth;
class ComPlatterController extends Controller
{
    public $route = 'admin/com-platter' ;
    public $view = 'admin.menu.com-platter' ;
    public $controllerName = 'เมนู com-platter (เมนูผสมขนาดกลาง) ' ;
    public $categoryId = 9 ;
    public $cntImg = 4 ;
    public $resize ;
    ...
    public function __construct(){
        ...
        $resize[1] = ['w'=>474,'h'=>474]; 
        $resize[2] = ['w'=>234,'h'=>234]; 
        $resize[3] = ['w'=>474,'h'=>474]; 
        $resize[4] = ['w'=>234,'h'=>234];
        $this->resize = $resize ;
    }
    /**
