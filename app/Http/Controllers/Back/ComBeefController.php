...
use stdClass ;
use Auth;
class ComBeefController extends Controller
{
    public $route = 'admin/com-beef' ;
    public $view = 'admin.menu.com-beef' ;
    public $controllerName = 'เมนู com-beef (เมนูผสมขนาดเล็ก) ' ;
    public $categoryId = 7 ;
    public $cntImg = 3 ;
    public $resize ;
