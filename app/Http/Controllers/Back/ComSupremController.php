...
use stdClass ;
use Auth;
class ComSupremController extends Controller
{
    public $route = 'admin/com-suprem' ;
    public $view = 'admin.menu.com-suprem' ;
    public $controllerName = 'เมนู com-suprem (เมนูผสมขนาดกลาง) ' ;
    public $categoryId = 8 ;
    public $cntImg = 4 ;
    public $resize ;
