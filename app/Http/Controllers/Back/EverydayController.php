...
{
    public $route = 'admin/everyday' ;
    public $view = 'admin.menu.everyday' ;
    public $controllerName = 'เมนู everyday ' ;
    ...
    public function __construct(){
        ...
        $resize[1] = ['w'=>980,'h'=>576]; 
        $resize[2] = ['w'=>484,'h'=>484]; 
        $resize[3] = ['w'=>484,'h'=>484]; 
        $resize[4] = ['w'=>980,'h'=>152];
        $this->resize = $resize ;
    }
